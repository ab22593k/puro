...
class SelfCommand extends PuroCommand {
  SelfCommand() {
    addSubcommand(SelfUninstallCommand());
  }
  ...
  @override
  final description = 'Manage the puro tool itself';
  ...
  Future<CommandResult> run() async {
    return CommandHelpResult(didRequestHelp: false, usage: usageWithoutDescription);
  }
}

class SelfUninstallCommand extends PuroCommand {
