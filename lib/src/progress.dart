...
/// Abstract node in a progress tree for status-line rendering.
///
/// Displays nested progress via [Terminal.status] and supports child
/// [ActiveProgressNode]s. Use [wrap] to run an operation with progress tracking.
...
/// A mutable progress node with [description], [progress], and [complete] state.
///
/// Supports delayed visibility, HTTP response tracking, and git clone progress.
...
/// The root of the progress tree. Wires child-node changes into [Terminal.status].
